...
func extractCSRFToken(t *testing.T, body string) string {
	...
	// data… including our CSRF token. Because the CSRF token is a base64 encoded
	// string it will potentially include the + character, and this will be escaped
	// to &#43;. So after extracting the token from the HTML we need to run it
	// through html.UnescapeString() to get the original token value.
